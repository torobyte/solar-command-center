...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Monitor your solar inverter" },
      { name: "description", content: "Monitor and manage your solar inverter from anywhere." },
      { property: "og:title", content: "Monitor your solar inverter" },
      { name: "twitter:title", content: "Monitor your solar inverter" },
      { property: "og:description", content: "Monitor and manage your solar inverter from anywhere." },
      { name: "twitter:description", content: "Monitor and manage your solar inverter from anywhere." },
