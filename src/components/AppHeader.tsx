...
import { Sun, LogOut, ShieldCheck, LayoutGrid, Menu, UserCircle2, Sparkles, KeyRound } from "lucide-react";
...
export function AppHeader() {
  ...
  const onApi = location.pathname.startsWith("/api-keys");
  ...
  const items: NavItem[] = [
    ...
    { to: "/api-keys", label: "API", icon: KeyRound, active: onApi },
